...
const OPTIONS: InstallOption[] = [
  {
    ...
    label: "macOS",
    icon: "",
    command: "curl -fsSL compressx.asmith.media/install.sh | sh",
  ...
  },
  {
    ...
    label: "Windows",
    icon: "",
    command: "irm compressx.asmith.media/install.ps1 | iex",
    note: "Run in PowerShell. NVIDIA GPU recommended for CUDA acceleration.",
    requirement: "Requires Node.js 18+ and Python 3.11+",
  },
  {
    key: "npm",
