    ...
    <div className="min-h-screen bg-black text-white font-mono">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16 border-t border-gray-900 font-sans">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 text-sm">
            Source models from Ollama or LM Studio with{" "}
            <code className="text-green-400 bg-gray-900 px-1.5 py-0.5 rounded text-xs">
              --source
            </code>
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-8">
          ...
          <div className="bg-gray-950 border border-gray-900 rounded-lg p-5">
            <div className="flex items-baseline gap-2 mb-2">
              <h3 className="text-white font-bold">LM Studio</h3>
              <span className="text-cyan-400 text-[10px] bg-cyan-500/10 px-2 py-0.5 rounded">
                SOURCE + TARGET
              </span>
            </div>
            <p className="text-gray-500 text-xs mb-3">
              Scan your LM Studio library with{" "}
              <code className="text-green-400">--source lmstudio</code>, or deploy
              compressed GGUFs into{" "}
              <code className="text-green-400">~/.lmstudio/models/</code>.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              ...
              It scans your local Ollama library (or{" "}
              <code className="text-green-400 bg-gray-900 px-1.5 py-0.5 rounded">--source lmstudio</code>)
              and auto-detects your GPU/RAM to find models that could be smaller.
            </p>
          </div>
          <div>
      ...
      <section id="docs" className="max-w-4xl mx-auto px-6 py-20 border-t border-gray-900">
        ...
        <div className="space-y-4">
          {[
            ...
            { cmd: "compressx scan --source lmstudio", desc: "Scan your LM Studio models directory for GGUFs to compress" },
            { cmd: "compressx compress Qwen/Qwen3-4B --source lmstudio -q q3_k_m", desc: "Re-quantize a model from LM Studio (~30 sec, no download)" },
